...
function CustomSingleScroll({item,navigation}){
    // alert(JSON.stringify(item))
    const [defaultcolor,bluecolor]=React.useState(false)
    return(
    <TouchableOpacity onPress={()=>navigation.navigate('CartDetail',{item})} style={{width:250,marginLeft:5,borderWidth:0.3,borderColor:'#dddddd',borderRadius:5,marginRight:10}}>
  ...
  export default CustomSingleScroll