...
function SeeAllResturants({item,navigation}){
    // alert(JSON.stringify(item))
    const [defaultcolor,bluecolor]=React.useState(false)
    console.log('dakshdlkahsdadhaldhashdas',item)
    return(
    
    <TouchableOpacity onPress={()=>navigation.navigate('CartDetail',{item})} style={{width:'95%',marginVertical:5,borderWidth:0.3,borderColor:'#dddddd',borderRadius:5,marginRight:10}}>
